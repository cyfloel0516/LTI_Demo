...
###
  define('APP_NAME', 'Syracuse University Youtube Project');
  define('SESSION_NAME', 'SU_YOUTUBE_SESSION');
  define('BASE_PATH', '/');
...
###
  define('DB_NAME', 'mysql:dbname=captions;host=mysql:3306');  // e.g. 'mysql:dbname=MyDb;host=localhost' or 'sqlite:php-rating.sqlitedb'
